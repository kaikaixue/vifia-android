...
import com.vifia.module_home.bean.CommentDetailBean;
import com.vifia.module_home.bean.ReplyDetailBean;
...
public class CommentExpandAdapter extends BaseExpandableListAdapter {
    ...
    public int getChildrenCount(int i) {
        if(commentBeanList.get(i).getList() == null){
            ...
            return commentBeanList.get(i).getList().size()>0 ? commentBeanList.get(i).getList().size():0;
        }
...
//        });
    ...
    public View getChildView(final int groupPosition, int childPosition, boolean b, View convertView, ViewGroup viewGroup) {
        ...
        String replyUser = commentBeanList.get(groupPosition).getList().get(childPosition).getNickName();
